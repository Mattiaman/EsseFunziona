...
<div class="col-sm-10">
	...
	<br>
			...
			<form class="form-horizontal" method="post" action="CreazioneRicevimento">
			  ...
			  <div class="form-group">
			    <label class="control-label col-sm-2" for="orarioRicevimento">Orario:</label>
			    <div class="col-sm-4">
			     <input name="orarioRicevimento" type="datetime" class="form-control" /> 
			    </div> 
			  </div>
			  <div class="form-group">
			    <label class="control-label col-sm-2" for="aulaRicevimento">Aula:</label>
			    <div class="col-sm-4">
			     <input name="aulaRicevimento" type="text" class="form-control" /> 
			    </div> 
			  </div>
			  <div class="form-group">
