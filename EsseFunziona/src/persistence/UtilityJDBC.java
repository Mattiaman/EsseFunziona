	...
	public void createDatabase() {
		...
		try {
			String create=
					...
					"create table prenota(\"id\" bigint primary key, idAppello bigint REFERENCES appello(\"id\"), matricolaStudente CHARACTER(6) REFERENCES studente(\"matricola\"), dataPrenotazione DATE, voto int);"+
